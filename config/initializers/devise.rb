...
Devise.setup do |config|
  ...
  config.mailer_sender = 'noreply@flowtrace.com'
  ...
  # ==> Turbo configuration
  # If your app is using Turbo, Turbo::Controller will raise ActionController::InvalidAuthenticityToken
  # when non-GET requests are made during unconfirmed navigation.
  #
  # By setting this to :exception the requests will be allowed.
